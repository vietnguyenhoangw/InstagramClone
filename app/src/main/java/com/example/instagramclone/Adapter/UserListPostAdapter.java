...
public class UserListPostAdapter extends RecyclerView.Adapter<UserListPostAdapter.VH> {

    Context context;
    ArrayList<NewFeed> data;

    public UserListPostAdapter(Context context, ArrayList<NewFeed> data) {
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View convertView = layoutInflater.inflate(R.layout.post_item, parent, false);
